...
(function ($) {
    ...
    $.fn.bdt = function (options, callback) {
        ...
        return this.each(function () {
            ...
            obj.before(
                $('<div/>')
					...
					/* dropdown select box show or hide */
                    /* .append(
                        $('<div/>')
                            .addClass('pull-left')
							//.addClass('pull-right')
			...
			/*footer pagination area hide or show*/
			obj.after(
                $('<div/>')
            ...
            /* footer pagination no change previous or next*/
			$('body').on('click', '.pagination li', function (event) {
             ...
             /* pagination dropdown select change or no change*/
        ...
        function addPages() {
            ...
            /* pagination er majer 1,2,3 ..box bar*/
            ...
            $('#table-footer')
                ...
                .append(
                    $('<nav/>')
                        .addClass('pull-right')
						//.addStyle('margin-right:500px;')
						//.addClass('pull-left')
                        .attr('id', 'table-nav')
                        .append(
                            pages
                                .addClass('pagination pull-right')
								//.addClass('pagination pull-left')
                                .prepend(
                                    $('<li/>')
                                        .addClass('disabled')
                                        .data('page', 'previous')
         ...
         */
		 ...
		 /* total body no change work here*/
         ...
         */
		 ...
		 /* change previous and next and work here*/
